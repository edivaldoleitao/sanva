...
public class TelaController implements Initializable, EventHandler<Event> {
    ...
    public void handle(Event event) {
        ...
        catch(NomeJogadorException | NumeroCamisaException | LimiteJogadoresException | EquipeException e) {
    ...
    private void adicionarJogador() throws NomeJogadorException, NumeroCamisaException, LimiteJogadoresException{
        if (!nomeJogador.getText().isEmpty() && !camisaJogador.getText().isEmpty()) {
        	...
        	catch (NomeJogadorException | NumeroCamisaException | LimiteJogadoresException ex) {
        		Alert a = new Alert(Alert.AlertType.INFORMATION);
                a.setContentText(ex.getMessage());
                a.show();
			}
    ...
    private void removerJogador() throws EquipeException {
