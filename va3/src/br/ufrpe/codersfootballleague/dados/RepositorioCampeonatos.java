...
public class RepositorioCampeonatos implements IRepositorioCampeonatos {
     ...
     */
    @Override
    public void adicionar(Campeonato c) throws CampeonatoException {
        for (Campeonato qualquer : campeonatos) {
            if (c.getNome().equals(qualquer.getNome())) {
                throw new CampeonatoException("Campeonato com mesmo nome já existente");
            }
        }
        campeonatos.add(c);
        salvar();
    ...
    public Campeonato consultar(String nome) throws CampeonatoException {
        ...
        throw new CampeonatoException("Campeonato não existe");
    }
     ...
     */
    @Override
    public void remove(String nome) throws CampeonatoException {
        for (Campeonato qualquer : campeonatos) {
            if (qualquer.getNome().equals(nome)) {
